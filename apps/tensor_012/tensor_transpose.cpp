 ...
 * Functions in this file:
    *  3 sorts:
        * transpose_coo_012_012_3
        * transpose_coo_012_021_3
        * transpose_coo_012_102_3
        * transpose_coo_012_120_3
        * transpose_coo_012_201_3
        * transpose_coo_012_012_3
    * 2 sorts:
        * transpose_coo_012_01_2
        * transpose_coo_012_02_2
        * transpose_coo_012_10_2
        * transpose_coo_012_12_2
        * transpose_coo_012_20_2
        * transpose_coo_012_21_2
    * 1 sort:
        * transpose_coo_012_0_1
        * transpose_coo_012_1_1  
        * transpose_coo_012_2_1
    * 0 sort:
        * transpose_coo_012_0
 **/
...
int transpose_coo_012_012_3(struct coo_t *C_coords, int c_size, int order, int *dimensions);
int transpose_coo_012_021_3(struct coo_t *C_coords, int c_size, int order, int *dimensions);
int transpose_coo_012_102_3(struct coo_t *C_coords, int c_size, int order, int *dimensions);
int transpose_coo_012_120_3(struct coo_t *C_coords, int c_size, int order, int *dimensions);
int transpose_coo_012_201_3(struct coo_t *C_coords, int c_size, int order, int *dimensions);
int transpose_coo_012_210_3(struct coo_t *C_coords, int c_size, int order, int *dimensions);

int transpose_coo_012_01_2(struct coo_t *C_coords, int c_size, int order, int *dimensions);
int transpose_coo_012_02_2(struct coo_t *C_coords, int c_size, int order, int *dimensions);
int transpose_coo_012_10_2(struct coo_t *C_coords, int c_size, int order, int *dimensions);
int transpose_coo_012_12_2(struct coo_t *C_coords, int c_size, int order, int *dimensions);
int transpose_coo_012_20_2(struct coo_t *C_coords, int c_size, int order, int *dimensions);
int transpose_coo_012_21_2(struct coo_t *C_coords, int c_size, int order, int *dimensions);

int transpose_coo_012_0_1(struct coo_t *C_coords, int c_size, int order, int *dimensions);
int transpose_coo_012_1_1(struct coo_t *C_coords, int c_size, int order, int *dimensions);
int transpose_coo_012_2_1(struct coo_t *C_coords, int c_size, int order, int *dimensions);

int transpose_coo_012_0(struct coo_t *C_coords, int c_size, int order, int *dimensions);
...
int main(int argc, char* argv[]) {
 // std::string filename = "/home/xwb/taco/transpose/taco/research/benchmark/nell-2.tns"; 
  std::string filename = "/home/xwb/taco/transpose/taco/research/benchmark/11.tns";
// std::string filename = "/home/xwb/taco/transpose/taco/research/benchmark/10.tns";  
// Read tensor data  
  int order = 3;
  ...
  t.clear_cache();
    ...
    taco::util::Timer t1;                                   
    t1.start();                                             
    transpose_coo_012_012_3(A, size, order, dimensions);
    t1.stop();                                              
    taco::util::TimeResults r1 = t1.getResult();        
    cout << "transpose_coo_012_012_3:" << endl; 
    cout << r1 <<  endl;   
    t1.clear_cache();
   ...
   taco::util::Timer t2;                                   
   t2.start();                                             
   transpose_coo_012_021_3(A, size, order, dimensions);
   t2.stop();                                              
   taco::util::TimeResults r2 = t2.getResult();        
   cout << "transpose_coo_012_021_3:" << endl; cout << r2 <<  endl;   
   t2.clear_cache();
  ...
  taco::util::Timer t3;                                   
  t3.start();                                             
  transpose_coo_012_102_3(A, size, order, dimensions);
  t3.stop();                                              
  taco::util::TimeResults r3 = t3.getResult();        
  cout << "transpose_coo_012_102_3:\t"  << endl; cout<< r3 << "" << endl;   
  t3.clear_cache();
  ...
  taco::util::Timer t4;                                   
  t4.start();                                             
  transpose_coo_012_120_3(A, size, order, dimensions);
  t4.stop();                                              
  taco::util::TimeResults r4 = t4.getResult();        
  cout << "transpose_coo_012_120_3:\t" << endl; cout << r4 << "" << endl;   
  t4.clear_cache();
  ...
  taco::util::Timer t5;                                   
  t5.start();                                             
  transpose_coo_012_201_3(A, size, order, dimensions);
  t5.stop();                                              
  taco::util::TimeResults r5 = t5.getResult();        
  cout << "transpose_coo_012_201_3:\t"  << endl; cout<< r5 << "" << endl;   
  t5.clear_cache();
  ...
  taco::util::Timer t6;                                   
  t6.start();                                             
  transpose_coo_012_210_3(A, size, order, dimensions);
  t6.stop();                                              
  taco::util::TimeResults r6 = t6.getResult();        
  cout << "transpose_coo_012_210_3:\t"  << endl; cout<< r6 << "" << endl;   
  t6.clear_cache();
...
qsort(A, size, sizeof(struct coo_t), cmp_012);
  ...
  taco::util::Timer t9;                                   
  t9.start();                                             
  transpose_coo_012_01_2(A, size, order, dimensions);
  t9.stop();                                              
  taco::util::TimeResults r9 = t9.getResult();        
  cout << "transpose_coo_012_01_2:\t\t"  << endl; cout<< r9 << "" << endl;   
  t9.clear_cache();
  ...
  taco::util::Timer t12;                                   
  t12.start();                                             
  transpose_coo_012_02_2(A, size, order, dimensions);
  t12.stop();                                              
  taco::util::TimeResults r12 = t12.getResult();        
  cout << "transpose_coo_012_02_2:\t\t"  << endl; cout<< r12 << "" << endl;   
  t12.clear_cache();
  ...
  taco::util::Timer t10;                                   
  t10.start();                                             
  transpose_coo_012_10_2(A, size, order, dimensions);
  t10.stop();                                              
  taco::util::TimeResults r10 = t10.getResult();        
  cout << "transpose_coo_012_10_2:\t\t"  << endl; cout<< r10 << "" << endl;   
  t10.clear_cache();
  ...
  taco::util::Timer t8;                                   
  t8.start();                                             
  transpose_coo_012_12_2(A, size, order, dimensions);
  t8.stop();                                              
  taco::util::TimeResults r8 = t8.getResult();        
  cout << "transpose_coo_012_12_2:\t\t"  << endl; cout<< r8 << "" << endl;   
  t8.clear_cache();
  ...
  taco::util::Timer t11;                                   
  t11.start();                                             
  transpose_coo_012_20_2(A, size, order, dimensions);
  t11.stop();                                              
  taco::util::TimeResults r11 = t11.getResult();        
  cout << "transpose_coo_012_20_2:\t\t"  << endl; cout<< r11 << "" << endl;   
  t11.clear_cache();
  ...
  taco::util::Timer t7;                                   
  t7.start();                                             
  transpose_coo_012_21_2(A, size, order, dimensions);
  t7.stop();                                              
  taco::util::TimeResults r7 = t7.getResult();        
  cout << "transpose_coo_012_21_2:\t\t"  << endl; cout<< r7 << "" << endl;   
  t7.clear_cache();
 ...
 qsort(A, size, sizeof(struct coo_t), cmp_012);
  ...
  taco::util::Timer t13;                                   
  t13.start();                                             
  transpose_coo_012_0_1(A, size, order, dimensions);
  t13.stop();                                              
  taco::util::TimeResults r13 = t13.getResult();        
  cout << "transpose_coo_012_0_1:\t\t"  << endl; cout<< r13 << "" << endl;   
  t13.clear_cache();
 ...
 qsort(A, size, sizeof(struct coo_t), cmp_012);
  ...
  taco::util::Timer t14;                                   
  t14.start();                                             
  transpose_coo_012_1_1(A, size, order, dimensions);
  t14.stop();                                              
  taco::util::TimeResults r14 = t14.getResult();        
  cout << "transpose_coo_012_1_1:\t\t"  << endl; cout<< r14 << "" << endl;   
  t14.clear_cache();
 ...
 qsort(A, size, sizeof(struct coo_t), cmp_012);
  ...
  taco::util::Timer t15;                                   
  t15.start();                                             
  transpose_coo_012_2_1(A, size, order, dimensions);
  t15.stop();                                              
  taco::util::TimeResults r15 = t15.getResult();        
  cout << "transpose_coo_012_2_1:\t\t"  << endl; cout<< r15 << "" << endl;   
  t15.clear_cache();
...
// 0 sort
 ...
 qsort(A, size, sizeof(struct coo_t), cmp_012);
  ...
  taco::util::Timer t16;                                   
  t16.start();                                             
  transpose_coo_012_0(A, size, order, dimensions);
  t16.stop();                                              
  taco::util::TimeResults r16 = t16.getResult();        
  cout << "transpose_coo_012_0:\t\t"  << endl; cout<< r16 << "" << endl;   
  t16.clear_cache();
...
int transpose_coo_012_012_3(struct coo_t *C_coords, int c_size, int order, int *dimensions) {
	...
	int32_t *B0_count = (int32_t *)calloc((B0_size+1 ), sizeof(int32_t));
...
//	for (int i = 0; i < c_size; i++) {
//		cout << C_coords[i].idx0 << "|" << C_coords[i].idx1 << "|" << C_coords[i].idx2 << "|" << C_coords[i].val << endl;
//	}
//        cout<<"***********"<<endl;
...
//		cout<<idx1<<endl;
	...
	for (int i = 0; i <c_size; i ++) {
		 C_coords_scratch[quotient_10[bucket_10[perm[i]]]] = C_coords[perm[i]];
		quotient_10[bucket_10[perm[i]]] ++;
	}
        memcpy(C_coords, C_coords_scratch, c_size*sizeof(struct coo_t));
...
//                 cout<<idx2<<endl;
	...
	// Move the items back to the buckets.
	for (int i =0; i <c_size; i ++) {
		C_coords_scratch[quotient_201[bucket_201[perm[i]]]] = C_coords[perm[i]];
		quotient_201[bucket_201[perm[i]]] ++;
	}
	 memcpy(C_coords, C_coords_scratch, c_size*sizeof(struct coo_t));

	for (int i = 0; i < c_size; i++) {
		cout << C_coords[i].idx0 << "|" << C_coords[i].idx1 << "|" << C_coords[i].idx2 << "|" << C_coords[i].val << endl;//geshi
	}
	    cout<<"***********"<<endl;
...
//		cout<<idx2<<endl;
	...
	// Move the items back to the buckets.
	for (int i = 0; i < c_size; i ++) {
		C_coords_scratch[quotient_20[bucket_20[perm[i]]]] = C_coords[perm[i]];
		quotient_20[bucket_20[perm[i]]] ++;
	}
