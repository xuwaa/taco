 ...
 * Functions in this file:
    * transpose_coo_210_012_3
    * transpose_coo_210_021_3
    * transpose_coo_210_102_3
    * transpose_coo_210_120_3
    * transpose_coo_210_210_3
    * transpose_coo_210_201_3
    * transpose_coo_210_12_2
    * transpose_coo_210_21_2
 **/
...
int main(int argc, char* argv[]) {
  ...
  taco::util::Timer t1;                                   
  t1.start();                                             
  transpose_coo_210_012_3(A, size, order, dimensions);
  t1.stop();                                              
  taco::util::TimeResults r1 = t1.getResult();        
  cout << "transpose_coo_210_012_3:" << endl; 
  cout << r1 <<  endl;   
  t1.clear_cache();
  ...
  taco::util::Timer t2;                                   
  t2.start();                                             
  transpose_coo_210_021_3(A, size, order, dimensions);
  t2.stop();                                              
  taco::util::TimeResults r2 = t2.getResult();        
  cout << "transpose_coo_210_021_3:" << endl; cout << r2 <<  endl;   
  t2.clear_cache();
 ...
 qsort(A, size, sizeof(struct coo_t), cmp_012);
  ...
  taco::util::Timer t3;                                   
  t3.start();                                             
  transpose_coo_210_102_3(A, size, order, dimensions);
  t3.stop();                                              
  taco::util::TimeResults r3 = t3.getResult();        
  cout << "transpose_coo_210_102_3:\t"  << endl; cout<< r3 << "" << endl;   
  t3.clear_cache();
  ...
  taco::util::Timer t4;                                   
  t4.start();                                             
  transpose_coo_210_120_3(A, size, order, dimensions);
  t4.stop();                                              
  taco::util::TimeResults r4 = t4.getResult();        
  cout << "transpose_coo_210_120_3:\t" << endl; cout << r4 << "" << endl;   
  t4.clear_cache();
  ...
  taco::util::Timer t5;                                   
  t5.start();                                             
  transpose_coo_210_201_3(A, size, order, dimensions);
  t5.stop();                                              
  taco::util::TimeResults r5 = t5.getResult();        
  cout << "transpose_coo_210_201_3:\t"  << endl; cout<< r5 << "" << endl;   
  t5.clear_cache();
  ...
  taco::util::Timer t6;                                   
  t6.start();                                             
  transpose_coo_210_210_3(A, size, order, dimensions);
  t6.stop();                                              
  taco::util::TimeResults r6 = t6.getResult();        
  cout << "transpose_coo_210_210_3:\t"  << endl; cout<< r6 << "" << endl;   
  t6.clear_cache();
  ...
  taco::util::Timer t7;                                   
  t7.start();                                             
  transpose_coo_210_21_2(A, size, order, dimensions);
  t7.stop();                                              
  taco::util::TimeResults r7 = t7.getResult();        
  cout << "transpose_coo_210_21_2:\t\t"  << endl; cout<< r7 << "" << endl;   
  t7.clear_cache();
  ...
  taco::util::Timer t8;                                   
  t8.start();                                             
  transpose_coo_210_12_2(A, size, order, dimensions);
  t8.stop();                                              
  taco::util::TimeResults r8 = t8.getResult();        
  cout << "transpose_coo_210_21_2:\t\t"  << endl; cout<< r8 << "" << endl;   
  t8.clear_cache();
